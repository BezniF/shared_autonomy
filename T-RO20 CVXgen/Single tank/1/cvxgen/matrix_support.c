...
void multbymG(double *lhs, double *rhs) {
  lhs[0] = -rhs[0]*(-params.tau[0]*params.dotx[0])-rhs[1]*(-params.tau[0]*params.dotx[1])-rhs[2]*(-params.tau[0]*params.dotx[2])-rhs[3]*(-params.tau[0]*params.dotx[3])-rhs[4]*(-params.tau[0]*params.dotx[4])-rhs[5]*(-params.tau[0]*params.dotx[5]);
}
...
void pre_ops(void) {
  work.quad_759852212224[0] = params.Fd[0]*params.Fd[0]+params.Fd[1]*params.Fd[1]+params.Fd[2]*params.Fd[2]+params.Fd[3]*params.Fd[3]+params.Fd[4]*params.Fd[4]+params.Fd[5]*params.Fd[5];
}
